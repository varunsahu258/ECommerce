...
JENKINS_IMAGE="${JENKINS_IMAGE:-ecommerce/jenkins-tools:latest}"
...
echo "Building Jenkins image with docker + kubectl + python + chrome tooling..."
docker build -t "${JENKINS_IMAGE}" -f docker/jenkins/Dockerfile .
